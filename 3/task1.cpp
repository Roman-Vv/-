...
это сортировка выбором — ищем минимум
...
/* 
 Задание 2 а: пузырьковая сортировка
...
/* 
 Задание 2 б: быстрая сортировка (quicksort)
...
тут сначала сортируем числа на два массива,
потом каждый сортируем отдельно и выводим
*/
...
void sortDescRange(int mas[], int n, int n1, int n2) {
    // проверяем что границы нормальные
    if (n1 < 0) n1 = 0;
    if (n2 >= n) n2 = n - 1;
    if (n1 > n2) return;
